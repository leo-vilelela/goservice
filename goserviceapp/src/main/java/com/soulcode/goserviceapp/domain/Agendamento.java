...
public class Agendamento {
    ...
    @NotNull(message = "O estatus do agendamento não pode ser vazio.")
    ...
    public Agendamento(Long id, Cliente cliente, Prestador prestador, Servico servico, StatusAgendamento statusAgendamento, LocalTime hora, LocalDate data, LocalDateTime dataHoraRegistro) {
        this.id = id;
